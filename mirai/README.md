...
| 1.1 | 🟢 Low | **Scraper Progress, Scan Modes & Telemetry** | Library & Scraper | In-modal scan mode confirmation prompt (Smart Scan vs Force Re-fetch), animated progress bar with active title telemetry, batch outcome stats, and post-run diagnostic logs. | ✅ Implemented |
