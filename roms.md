...
| 3 | `Sonic Drift (Japan) (En) (Demo)` | 0.50 MB | Curated Showcase Demo |

### `gb` — Game Boy (DMG) (3 titles, 2.56 MB)

| # | Filename | Size | Classification |
|---|---|---|---|
| 1 | `Dragonborne (World) (Demo) (Aftermarket) (Unl)` | 2.00 MB | Curated Showcase Demo |
| 2 | `Gunman Clive (World) (Demo) (Aftermarket) (Unl)` | 0.06 MB | Curated Showcase Demo |
| 3 | `Zelda - Majora's Mask (World) (v1.1) (Demo) (Aftermarket) (Unl)` | 0.50 MB | Curated Showcase Demo |

### `gba` — Game Boy Advance (3 titles, 40.00 MB)
...
| 3 | `Pokemon Mystery Dungeon - Red Rescue Team (USA) (Demo) (Kiosk)` | 16.00 MB | Curated Showcase Demo |

### `gbc` — Game Boy Color (3 titles, 8.50 MB)
...
| 3 | `Tetris DS (USA) (Demo) (Kiosk)` | 16.00 MB | Curated Showcase Demo |
...
| 3 | `Sonic 3D Blast (USA) (Demo) (Part One) (Sega Channel)` | 3.00 MB | Curated Showcase Demo |

### `snes` — Super Nintendo (SNES) (3 titles, 2.65 MB)
