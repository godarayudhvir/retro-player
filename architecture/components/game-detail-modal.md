...
- **Spatial Gamepad & Keyboard Navigation**: Supports focus navigation between Close (`X`), Play button, and Favorite button via D-pad or Arrow keys, and dismisses on `Escape` or `B` button.
