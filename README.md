...
[![Version: v1.1.1](https://img.shields.io/badge/Version-v1.1.1-emerald?style=for-the-badge&logo=semver&logoColor=white)](https://github.com/godarayudhvir/retro-player)
...
| **[🎮 Controls, Keybindings & Accessibility Guide](guides/controls.md)** | Full gamepad button mappings, dashboard spatial navigation, multimodal accessibility heuristics, and in-game controls. |
