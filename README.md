...
| **[♿ Universal Accessibility Guide](guides/accessibility.md)** | Multimodal input heuristics, gamepad/keyboard/touch navigation across Onboarding & Modals, and phased roadmap. |
