export const SILVER_MILESTONES = [
  {
  ...
  {
    id: 'poke_tower_duo',
    title: 'Wings of Legend (Lugia)',
    description: 'Dive deep into the Whirl Islands with the Silver Wing and capture the legendary guardian Lugia.',
    category: 'pokemon',
    type: 'legendary',
    icon: 'Crown',
    isPerRom: true
