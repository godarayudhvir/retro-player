/**
 * Dedicated Pokémon Silver Version Save Parser (Game Boy Color - 32 KB SRAM).
 */
import { countSetBits, readUint24BE } from '../../../binaryUtils.js';

export function parsePokemonSilver(data) {
  if (!data || data.length < 0x8000) return null;

  // Silver Checksum: 16-bit word at 0x2D69 (sum of bytes 0x2009 to 0x2D68)
  let sum = 0;
