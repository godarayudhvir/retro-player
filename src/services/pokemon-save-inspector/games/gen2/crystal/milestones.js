export const CRYSTAL_MILESTONES = [
  {
  ...
  {
    id: 'poke_crystal_suicune',
    title: 'North Wind Reincarnate',
    description: 'Track and battle the legendary Suicune at the Bell Tower in Pokémon Crystal.',
    category: 'pokemon',
    type: 'exclusive',
    icon: 'Sparkles',
    isPerRom: true
  ...
  {
    id: 'poke_crystal_unown',
    title: 'Archaeological Scholar',
    description: 'Uncover the ancient stone puzzles at the Ruins of Alph and unlock the Unown Dex in Crystal.',
    category: 'pokemon',
    type: 'exclusive',
    icon: 'Compass',
    isPerRom: true
  ...
  {
    id: 'poke_tower_duo',
    title: 'Wings of Legend',
    description: 'Summon and capture the guardian birds of the skies: Ho-Oh (Tin Tower) or Lugia (Whirl Islands).',
    category: 'pokemon',
    type: 'legendary',
    icon: 'Crown',
    isPerRom: true
