export const PEARL_MILESTONES = [
  ...
  },
  {
    ...
    description: 'Excavate an Armor Fossil from the Underground and revive Shieldon in Oreburgh City.',
    category: 'pokemon',
    type: 'legendary',
    icon: 'Star',
    isPerRom: true
  ...
  },
  {
    id: 'poke_palkia',
    title: 'Lord of Space',
    description: 'Brave the spatial distortion atop Spear Pillar and capture the legendary dragon Palkia.',
    category: 'pokemon',
    type: 'legendary',
    icon: 'Crown',
    isPerRom: true
