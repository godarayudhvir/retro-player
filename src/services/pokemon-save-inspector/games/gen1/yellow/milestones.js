export const YELLOW_MILESTONES = [
  {
    id: 'poke_journey_begun',
    title: 'Pallet Town Departure (Partner Pikachu)',
    description: 'Receive your loyal partner Pikachu from Professor Oak in Pallet Town.',
    category: 'pokemon',
    type: 'story',
    icon: 'Compass',
    isPerRom: true
  },
  {
    ...
    description: 'Maximize your partner Pikachu’s friendship score (score 200+).',
    category: 'pokemon',
    type: 'exclusive',
    icon: 'Star',
    isPerRom: true
  },
  {
    ...
    title: 'Anime Canon',
    description: 'Receive all three original gift starters (Bulbasaur, Charmander, Squirtle) from NPCs.',
    category: 'pokemon',
    type: 'exclusive',
    icon: 'Users',
    isPerRom: true
  ...
  },
  {
    ...
    description: 'Acquire HM01 Cut. Shrubs and small trees across Kanto now fear your existence.',
    category: 'pokemon',
    type: 'hm',
    icon: 'Activity',
    isPerRom: true
  ...
  },
  {
    ...
    description: 'Collect all 5 core Hidden Machines (HM01 through HM05).',
    category: 'pokemon',
    type: 'hm',
    icon: 'Award',
    isPerRom: true
  ...
  },
  {
    ...
    title: 'Mortal Wombat',
    description: 'Defeat the Karate Master at the Saffron Fighting Dojo and claim Hitmonlee or Hitmonchan.',
    category: 'pokemon',
    type: 'story',
    icon: 'Award',
    isPerRom: true
  ...
  },
  {
    ...
    title: 'Praise Helix!',
    description: 'Revive an ancient prehistoric fossil (Omanyte, Kabuto, or Aerodactyl) at the Cinnabar Island Lab.',
    category: 'pokemon',
    type: 'legendary',
    icon: 'Star',
    isPerRom: true
  ...
  },
  {
    ...
    description: 'Descend into Cerulean Cave and capture Mewtwo.',
    category: 'pokemon',
    type: 'legendary',
    icon: 'Crown',
    isPerRom: true
