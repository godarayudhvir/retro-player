/**
 * Dedicated Pokémon Black Version Save Parser (NDS - 512 KB Flash).
...
export function parsePokemonBlack(data) {
  ...
  return {
    ...
    events: {
      dreamyard: badgeCount >= 1,
      relicCastle: badgeCount >= 4,
      opelucidGym: badgeCount >= 8,
      nsCastle: badgeCount >= 8,
      defeatN: badgeCount >= 8,
      plasmaGhetsis: badgeCount >= 8
    },
    legendaries: {
      reshiram: badgeCount >= 8,
