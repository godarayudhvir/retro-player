...
1. **Strictly Non-Complete Titles**: All ROMs in this repository were **specifically curated to be non-complete evaluation software** (41 titles across 12 platforms).
...
### `game_gear` — Sega Game Gear (2 titles, 0.53 MB)
...
### `gb` — Game Boy (DMG) (1 title, 0.06 MB)
...
### `nds` — Nintendo DS (2 titles, 48.00 MB)
...
### `sega_genesis` — Sega Genesis / Mega Drive (2 titles, 5.00 MB)
...
### `snes` — Super Nintendo (SNES) (1 title, 2.00 MB)
