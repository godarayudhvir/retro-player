...
| ✅ | 🥈 Silver | +25G | `certified_tactile`| **Certified Tactile** | Connect and use a real physical USB or Bluetooth gamepad controller. | Physical gamepad button/axis input detected | Global |
